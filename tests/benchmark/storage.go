...
func (i *inMemoryStorage) ExecuteQuery(query *query.Query) ([]map[string]interface{}, error) {
	...
	switch eName {
	case entity.Name(reflect2.FullName(reflect.TypeOf(&shop{}))):
		return []map[string]interface{}{
			{"shop.id": 1, "shop.name": "shop1", "shop.profile_id": 1},
		}, nil
	case entity.Name(reflect2.FullName(reflect.TypeOf(&profile{}))):
		return []map[string]interface{}{
			{"prof.id": 1, "prof.description": "description1"},
		}, nil
	case entity.Name(reflect2.FullName(reflect.TypeOf(&book{}))):
		return []map[string]interface{}{
			{"book.id": 1, "book.name": "book1"},
		}, nil
	case entity.Name(reflect2.FullName(reflect.TypeOf(&author{}))):
		return []map[string]interface{}{
